...
from .models import Product,Shop,Category,CustomUser,ProductShop,ProductImage,ProductCategory,Review,PriceHistory,ReviewImage
...
class ReviewsList(APIView):
    ...
    def get(self, request, product_id):
        ...
        # Include ReviewImage instances in the response
